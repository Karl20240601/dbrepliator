...
public class SessionHolder {
    // session id  线程本地变量
    private static final ThreadLocal<String> sessionIdLocal = new NamedThreadLocal<>("sessionIdLocal");
    // session userIdentifier(这里为 user id) 线程本地变量
    private static final ThreadLocal<String> userIdLocal = new NamedThreadLocal<>("userIdLocal");
    // session 用户信息  线程本地变量
     ...
     */
    public static String getSessionIDStorePrefix() {

        return SessionConstants.SESSION_STORE_PREFIX;
    ...
    public static void setUserIdentifier(String userIdentifier) {
        userIdLocal.set(userIdentifier);
    }
