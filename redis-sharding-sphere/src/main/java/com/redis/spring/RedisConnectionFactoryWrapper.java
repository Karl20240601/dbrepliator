...
import com.redis.proxy.DelegatingWrapper;
import com.redis.proxy.InterceptingRedisConnectionInvocationHandler;
...
public class RedisConnectionFactoryWrapper implements RedisConnectionFactory, DelegatingWrapper {
    ...
    private static InvocationHandler newInvocationHandler(RedisConnection connection, RedisContext redisContext) {
        return new InterceptingRedisConnectionInvocationHandler(redisContext.getRedisKeyRedisSerializer(), connection, redisContext);
    }
